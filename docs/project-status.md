...
| Deployment pipeline        | ✅     | Pablesite y Eärendil se despliegan automáticamente en ARDA desde GitHub Actions a través de Tailscale                             |
...
| Manual   | Medium   | 🔄     | Strava implementado y OAuth completado; la API permanece inactiva hasta contratar la suscripción      | `docs/tasks/backend/earendil-personal-signals/` |
